...
class UserActivity extends AppCompatActivity {
    ...
    protected  void onCreate(Bundle savedInstanceActivity){
        ...
        if (auth.getCurrentUser() != null) {
            ...
            downloadImage(); //image de profil

            setUser();
            updateProfil(user);
        } else {
            Log.v("AndroBoum", "Je ne suis pas encore connecté");
        ...
        Button bouton = (Button) findViewById(R.id.Liste_btn);
        ...
        mFusedLocationClient.getLastLocation()
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        Log.v("AndroBoum", "Location : " + String.valueOf(location));
